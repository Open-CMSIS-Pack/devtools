...
if(OPT_OPTIMIZE STREQUAL "debug")
  set(CC_OPT "-On")
elseif(OPT_OPTIMIZE STREQUAL "size")
  set(CC_OPT "-Ohz")
elseif(OPT_OPTIMIZE STREQUAL "speed")
  set(CC_OPT "-Ohs")
elseif(OPT_OPTIMIZE STREQUAL "max")
  set(CC_OPT "-Ohs --no_size_constraints")
...
if(OPT_WARNINGS STREQUAL "no")
  set(CC_OPT "${CC_OPT} --no_warnings")
  set(LD_OPT "${LD_OPT} --no_warnings")
elseif(OPT_WARNINGS STREQUAL "all")
  # nothing to do
elseif(OPT_WARNINGS STREQUAL "Misra")
  message(WARNING "unsupported OPT_WARNINGS = '${OPT_WARNINGS}' !")
elseif(OPT_WARNINGS STREQUAL "AC5-like")
  message(WARNING "unsupported OPT_WARNINGS = '${OPT_WARNINGS}' !")
