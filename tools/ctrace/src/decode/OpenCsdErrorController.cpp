...
std::string OpenCsdErrorController::errorCodeName(ocsd_err_t code)
{
  ...
  case OCSD_OK:
    return "OCSD_OK";
  case OCSD_ERR_FAIL:
    return "OCSD_ERR_FAIL";
  case OCSD_ERR_MEM:
    return "OCSD_ERR_MEM";
  case OCSD_ERR_NOT_INIT:
    return "OCSD_ERR_NOT_INIT";
  case OCSD_ERR_INVALID_ID:
    return "OCSD_ERR_INVALID_ID";
  case OCSD_ERR_BAD_HANDLE:
    return "OCSD_ERR_BAD_HANDLE";
  case OCSD_ERR_INVALID_PARAM_VAL:
  ...
  case OCSD_ERR_NO_PROTOCOL:
    return "OCSD_ERR_NO_PROTOCOL";
  case OCSD_ERR_ATTACH_TOO_MANY:
    return "OCSD_ERR_ATTACH_TOO_MANY";
  case OCSD_ERR_ATTACH_INVALID_PARAM:
    return "OCSD_ERR_ATTACH_INVALID_PARAM";
  case OCSD_ERR_ATTACH_COMP_NOT_FOUND:
    return "OCSD_ERR_ATTACH_COMP_NOT_FOUND";
  case OCSD_ERR_RDR_FILE_NOT_FOUND:
    return "OCSD_ERR_RDR_FILE_NOT_FOUND";
  case OCSD_ERR_RDR_INVALID_INIT:
    return "OCSD_ERR_RDR_INVALID_INIT";
  case OCSD_ERR_RDR_NO_DECODER:
    return "OCSD_ERR_RDR_NO_DECODER";
  case OCSD_ERR_DATA_DECODE_FATAL:
    return "OCSD_ERR_DATA_DECODE_FATAL";
  case OCSD_ERR_DFMTR_NOTCONTTRACE:
    return "OCSD_ERR_DFMTR_NOTCONTTRACE";
  case OCSD_ERR_DFMTR_BAD_FHSYNC:
    return "OCSD_ERR_DFMTR_BAD_FHSYNC";
  case OCSD_ERR_BAD_PACKET_SEQ:
    return "OCSD_ERR_BAD_PACKET_SEQ";
  case OCSD_ERR_INVALID_PCKT_HDR:
    return "OCSD_ERR_INVALID_PCKT_HDR";
  case OCSD_ERR_PKT_INTERP_FAIL:
    return "OCSD_ERR_PKT_INTERP_FAIL";
  case OCSD_ERR_UNSUPPORTED_ISA:
    return "OCSD_ERR_UNSUPPORTED_ISA";
  case OCSD_ERR_HW_CFG_UNSUPP:
    return "OCSD_ERR_HW_CFG_UNSUPP";
  case OCSD_ERR_UNSUPP_DECODE_PKT:
    return "OCSD_ERR_UNSUPP_DECODE_PKT";
  case OCSD_ERR_BAD_DECODE_PKT:
    return "OCSD_ERR_BAD_DECODE_PKT";
  case OCSD_ERR_COMMIT_PKT_OVERRUN:
    return "OCSD_ERR_COMMIT_PKT_OVERRUN";
  case OCSD_ERR_MEM_NACC:
    return "OCSD_ERR_MEM_NACC";
  case OCSD_ERR_RET_STACK_OVERFLOW:
    return "OCSD_ERR_RET_STACK_OVERFLOW";
  case OCSD_ERR_DCDT_NO_FORMATTER:
    return "OCSD_ERR_DCDT_NO_FORMATTER";
  case OCSD_ERR_MEM_ACC_OVERLAP:
    return "OCSD_ERR_MEM_ACC_OVERLAP";
  case OCSD_ERR_MEM_ACC_FILE_NOT_FOUND:
    return "OCSD_ERR_MEM_ACC_FILE_NOT_FOUND";
  case OCSD_ERR_MEM_ACC_FILE_DIFF_RANGE:
    return "OCSD_ERR_MEM_ACC_FILE_DIFF_RANGE";
  case OCSD_ERR_MEM_ACC_RANGE_INVALID:
    return "OCSD_ERR_MEM_ACC_RANGE_INVALID";
  case OCSD_ERR_MEM_ACC_BAD_LEN:
    return "OCSD_ERR_MEM_ACC_BAD_LEN";
  case OCSD_ERR_TEST_SNAPSHOT_PARSE:
    return "OCSD_ERR_TEST_SNAPSHOT_PARSE";
  case OCSD_ERR_TEST_SNAPSHOT_PARSE_INFO:
    return "OCSD_ERR_TEST_SNAPSHOT_PARSE_INFO";
  case OCSD_ERR_TEST_SNAPSHOT_READ:
    return "OCSD_ERR_TEST_SNAPSHOT_READ";
  case OCSD_ERR_TEST_SS_TO_DECODER:
    return "OCSD_ERR_TEST_SS_TO_DECODER";
  case OCSD_ERR_DCDREG_NAME_REPEAT:
    return "OCSD_ERR_DCDREG_NAME_REPEAT";
  case OCSD_ERR_DCDREG_NAME_UNKNOWN:
    return "OCSD_ERR_DCDREG_NAME_UNKNOWN";
  case OCSD_ERR_DCDREG_TYPE_UNKNOWN:
    return "OCSD_ERR_DCDREG_TYPE_UNKNOWN";
  case OCSD_ERR_DCDREG_TOOMANY:
    return "OCSD_ERR_DCDREG_TOOMANY";
  case OCSD_ERR_DCD_INTERFACE_UNUSED:
    return "OCSD_ERR_DCD_INTERFACE_UNUSED";
  case OCSD_ERR_INVALID_OPCODE:
    return "OCSD_ERR_INVALID_OPCODE";
  case OCSD_ERR_I_RANGE_LIMIT_OVERRUN:
    return "OCSD_ERR_I_RANGE_LIMIT_OVERRUN";
  case OCSD_ERR_BAD_DECODE_IMAGE:
    return "OCSD_ERR_BAD_DECODE_IMAGE";
  case OCSD_ERR_LAST:
    return "OCSD_ERR_LAST";
  default:
