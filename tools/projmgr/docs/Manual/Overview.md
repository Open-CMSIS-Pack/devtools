...
Add to the project the possiblity to specify.  The issue might be that the project files become overwelming, alternative is to keep partitioning in separate files.
