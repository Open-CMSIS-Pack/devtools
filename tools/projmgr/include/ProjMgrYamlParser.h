...
static constexpr const char* YAML_AUTO_START = "auto-start";
static constexpr const char* YAML_AUTO_STOP = "auto-stop";
...
static constexpr const char* YAML_CONFIG_FILE = "config-file";
...
static constexpr const char* YAML_HARDWARE = "hardware";
...
static constexpr const char* YAML_INI = "ini";
...
static constexpr const char* YAML_MACS = "macs";
static constexpr const char* YAML_MLOPS = "mlops";
static constexpr const char* YAML_MODEL = "model";
...
static constexpr const char* YAML_NPU = "npu";
static constexpr const char* YAML_NPU_INFO = "npu-info";
...
static constexpr const char* YAML_OUT_DIR = "out-dir";
...
static constexpr const char* YAML_SIMULATOR = "simulator";
...
static constexpr const char* YAML_SYSTEMVIEW = "systemview";
static constexpr const char* YAML_TAPINDEX = "tapindex";
static constexpr const char* YAML_TARGET = "target";
...
static constexpr const char* YAML_TRACE_SINKS = "trace-sinks";
static constexpr const char* YAML_TRACEBUFFER = "tracebuffer";
static constexpr const char* YAML_SERIALWIRE = "serialwire";
...
static constexpr const char* YAML_VELA = "vela";
static constexpr const char* YAML_VELA_INI = "vela-ini";
...
protected:
  ...
  void ParseMlops(const YAML::Node& parent, const std::string& file, MlopsItem& mlops);
  ...
  void ParseSystemView(const YAML::Node& parent, const std::string& file, SystemViewItem& systemView);
