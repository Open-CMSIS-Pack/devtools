...
// 300... Validation Errors
  ...
  { "M389", { MsgLevel::LEVEL_WARNING3, CRLF_B, "" } },
  ...
  { "M393", { MsgLevel::LEVEL_WARNING3, CRLF_B, "Package has development version '%RELEASEVER%'" } },
  { "M394", { MsgLevel::LEVEL_ERROR,    CRLF_B, "Not Semantic Versioning: '%RELEASEVER%'" } },
